...
[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-response-body https://paste.srlihg.link/~qlmb
^https?:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-request-header https://paste.srlihg.link/~qlmb
...
const name = "Premium";
const appid = "com.xiaobingkj.QingLong.lifetime";
